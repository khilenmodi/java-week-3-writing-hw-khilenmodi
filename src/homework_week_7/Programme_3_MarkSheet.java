 ...
 * (marks is between o to 100 and if it is out of range print error message " Invalid Input, marks should
 * between o to 100) and find out total, percentage and result. if he is pass or fail on basis of percentage
 * (Pass>=35) and also give them grade if %>=80 A+, %>= 60 A, %> = 50 B, %> = 35 C, And print Mark Sheet in following
 * format
