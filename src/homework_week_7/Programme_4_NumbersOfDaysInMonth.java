 ...
 * If the parameter is not in that range false.
 * otherwise, if it is the valid range, calculate if the year is a leap year and return true if it is,
 * otherwise return false.
 * A year is a leap year if it is divisible by 4 but not by 100, or it is divisible by 400.
 * Example of input/output:
 * is LeapYear (-1600); should return false since the parameter is not in the range (1-9999)
 * is leapYear (1600); should return true since 1600 is a leap year
 * is leapYear (2017); should return false since 2017 is not a leap year
 * is leap year( 2000); should return true because 2000 is a leap year
 * Write another method getDaysInMonth with two parameter month and year. Both of type int.
 * if parameter month is & it or & gt;12 return -1.
 * If parameter year is & lt;1 or & gt;9999 than return -1.
 * This method needs to return the number of days in the month. Be careful about leap years
 * they have 29 days in month 2 (February).<p>
